...
const useWordle = (solution) => {
    ...
    const [useKeys, setUsedKeys] = useState({}) //{a: 'green', b: 'grey', c:'yellow'}
    ...
    const handleKeyup = ( {key} ) => { //key is for keyup event like e.target.key if not deconstructed
        if (key=== "Enter") {
            //conditions
    ...
    return {turn, currentGuess, guesses, isCorrect, useKeys, handleKeyup}
